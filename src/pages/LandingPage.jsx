          ...
          <div className="max-w-md mx-4 sm:mx-auto bg-white rounded-2xl shadow-xl p-6 sm:p-8">
            ...
            <div className="space-y-4 sm:space-y-6">
              <div>
                ...
                />
                {/* Red Warning Text */}
                <p className="text-red-600 text-xs sm:text-sm mt-2 font-medium flex items-center">
                  ...
                  Please add your full name otherwise there might be issues with your certificate
                </p>
              </div>
              <button
